...
"saghen/blink.cmp",
        ...
        opts = function(_, opts)
            ...
            opts.sources = vim.tbl_deep_extend("force", opts.sources or {}, {
                ...
                providers = {
                    lsp = {
                        ...
                        -- When linking markdown notes, I would get snippets of text in the
                    ...
                    path = {
                        ...
                        -- suggestions, I want those the show only if there are no path
                        -- suggestions
                        fallbacks = { "snippets", "buffer" },
                        -- min_keyword_length = 2,
                        opts = {
                    ...
                    snippets = {
                        ...
                        should_show_items = function()
                            ...
                            -- NOTE: remember that `trigger_text` is modified at that top of the file
                            return before_cursor:match(trigger_text .. "%w*$") ~= nil
                        end,
                        -- After accepting the completion, delete trigger_text characters
                    ...
                    dictionary = {
                        ...
                        opts = {
                            ...
                            --  Notice I'm also adding words I add to the spell dictionary
                            --  dictionary_files = {
            ...
            --  -- To specify options for snippets
